Ext.define('AutoMecanica.controller.cadastro.Cliente',{
	...
	onButtonClickIncluir: function(button, e, opts){
		var win = Ext.create('AutoMecanica.view.cadastro.ClientesForm');	
		win.show();
	},
						...
						Ext.Ajax.request({
							...
							success: function(conn, response, options, eOpts){
								...
								if(result.success){
									...
									AutoMecanica.util.Util.showToast('Cliente excluído!');
		...
		if(form.getForm().isValid()){
			...
			form.getForm().submit({
				...
				success: function(form, action){
					...
					var result = action;
					if(result.success){
						AutoMecanica.util.Util.showToast('Dados do cliente foram salvos!');
