...
if(isset($_GET['module'])) {
	...
	switch($module){
		...
		case "delete":
			...
			DELETE FROM usuario_empresa WHERE empresa_id = 7;
			DELETE FROM socios WHERE empresa_id = 7;
			DELETE FROM contatos WHERE empresa_id = 7;
			DELETE FROM parametros WHERE empresa_id = 7;
			DELETE FROM lancamentos WHERE empresa_id = 7;
			DELETE FROM lancamentosfixos WHERE empresa_id = 7;
			DELETE FROM tesouraria WHERE empresa_id = 7;
			DELETE FROM favorecidos WHERE empresa_id = 7;
			DELETE FROM notasfiscais WHERE empresa_id = 7;
			DELETE FROM anexos_lancamento WHERE empresa_id = 7;
			DELETE FROM balancete_demonstracao WHERE empresa_id = 7;
			*/
