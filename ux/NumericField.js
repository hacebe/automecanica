/* * GNU General Public License Usage
    ...
    Ext.define('Ux.NumericField', {
      ...
      setValue: function(value){
        // MOD - chamacs
        Ux.NumericField.superclass.setValue.apply(this, [value != null ? value.toString().replace('.', this.decimalSeparator) : value]);
      ...
      parseValue: function(value){
        ...
        return Ux.NumericField.superclass.parseValue.apply(this, [this.removeFormat(value)]);
      },
      ...
      getErrors: function(value) {
        // MOD - chamacs
        return Ux.NumericField.superclass.getErrors.apply(this, [this.removeFormat(value)]);
      },
